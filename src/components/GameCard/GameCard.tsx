...
export const GameCard: React.FC<GameCardProps> = ({ game }) => {
  ...
  return (
    <CardContainer>
      ...
      <StatsSection>
        <StatCard>
          ...
          {isDomeGame ? (
            ...
            <>
              <StatValue>
                <WeatherIcon>
                  {getWeatherIcon(isWeatherAvailable, game.weather.condition)}
                </WeatherIcon>
                <span>-</span>
              </StatValue>
            ...
            <>
              ...
              <StatDetail>{game.weather.condition}</StatDetail>
            </>
          )}
        </StatCard>
        ...
        <StatCard>
          ...
          {isDomeGame ? (
            ...
            <>
              <StatValue large={game.weather.windSpeed > 15}>
        ...
        <StatCard>
          ...
          game.awayScore !== undefined ? (
            <>
              <StatValue large>{game.homeScore + game.awayScore}</StatValue>
              <StatDetail>
            ...
            <>
              <StatValue large>{game.overUnder}</StatValue>
      ...
      {headToHeadDisplay.displayScorers.length > 0 && (
        <HeadToHeadSection>
          <HeadToHeadTitle>Last 3 Meeting TD Scorers</HeadToHeadTitle>
          <TDScorersList>
            {headToHeadDisplay.displayScorers.map((scorer, index) => (
            ...
            {headToHeadDisplay.fifthRow && (
              <TDScorerItem>
                <TDScorerName>{headToHeadDisplay.fifthRow.name}</TDScorerName>
                <TDScorerCount tdCount={headToHeadDisplay.fifthRow.count}>
                  {headToHeadDisplay.fifthRow.count}
                </TDScorerCount>
              </TDScorerItem>
            )}
          </TDScorersList>
